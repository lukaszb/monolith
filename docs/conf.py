# -*- coding: utf-8 -*-
#
# monolith documentation build configuration file, created by
...
project = u'monolith'
copyright = u'2011, Łukasz Balcerzak'
...
pdf_documents = [
    ('index', u'monolith', u'Documentation for monolith',
        u'Łukasz Balcerzak'),
]
